        ...
        $rootNode
            ...
            ->children()
                ...
                ->arrayNode('controller')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('filter_action')->defaultValue('anezi_imagine.controller:filterAction')->end()
                        ->scalarNode('filter_runtime_action')->defaultValue('anezi_imagine.controller:filterRuntimeAction')->end()
                    ->end()
                ->end()
