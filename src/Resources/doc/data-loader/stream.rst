...
The ``Anezi\ImagineBundle\Binary\Loader\StreamLoader`` allows to read images
...
.. code-block:: yaml
    ...
    services:
        acme.anezi_imagine.binary.loader.stream.profile_photos:
            class: "%anezi_imagine.binary.loader.stream.class%"
            arguments:
                - 'gaufrette://profile_photos/'
            tags:
                - { name: 'anezi_imagine.binary.loader', loader: 'stream.profile_photos' }
